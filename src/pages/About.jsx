                ...
                <MainWrapper pt={24} pb={12}>
                    <VStack width={['90%','90%','90%','90%']} margin={'auto'} alignItems={'flex-start'} fontSize={['sm', 'sm', 'md', 'md']} gap={'4'}>
                        ...
                        <UnorderedList pl={'8'} spacing={'3'}>
                            <TransitionDiv><ListItem><b>Holistic Learning: </b>We believe in providing holistic education that goes beyond textbooks. Our comprehensive curriculum ensures a deep understanding of scientific concepts while fostering critical thinking and problem-solving skills.</ListItem></TransitionDiv>
                            <TransitionDiv><ListItem><b>Experienced Faculty: </b>Our team of experienced and dedicated faculty members comprises subject experts who are passionate about teaching. They guide students through the complexities of Science and PCMB with clarity and enthusiasm.</ListItem></TransitionDiv>
                            <TransitionDiv><ListItem><b>Customized Approach: </b>Recognizing that every student is unique, we adopt a personalized approach to cater to individual learning needs. Our small class sizes facilitate one-on-one interactions, ensuring that each student receives the attention they deserve.</ListItem></TransitionDiv>
                            <TransitionDiv><ListItem><b>Proven Track Record: </b>Over the years, Proton Educations has garnered a reputation for producing academic achievers. Our success stories stand as a testament to the effectiveness of our teaching methodologies and the dedication of our students.</ListItem></TransitionDiv>
                            <TransitionDiv><ListItem><b>Focused PCMB Coaching: </b>For students pursuing the PCMB stream, our coaching program is tailored to provide a strong foundation in Physics, Chemistry, Mathematics, and Biology. We strive to nurture the next generation of scientists, engineers, and medical professionals.</ListItem></TransitionDiv>
                            <TransitionDiv><ListItem><b>Short-Concise Notes: </b>Providing short, concise and to the point notes which will help you ace the exam of your choice.</ListItem></TransitionDiv>
                        </UnorderedList>
                    </VStack>
                </MainWrapper>
            </TransitionWrapper>
